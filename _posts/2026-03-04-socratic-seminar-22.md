...
- BTC++ Exploit Edition wrap-up
  - [Conferência](https://btcplusplus.dev/conf/floripa26)
...
- [Gloria is not a maintainer anymore](https://github.com/bitcoin/bitcoin/pull/34517)

- [Mastering Taproot](https://github.com/aaron-recompile/mastering-taproot/tree/main/book/manuscript)

- [Recent OP_RETURN output statistics](https://delvingbitcoin.org/t/recent-op-return-output-statistics/2248)

- [Nunchuk adds silent payment support](https://xcancel.com/nunchuk_io/status/2021588854969414119)

- The future of Bitcoin Core GUI
  - [Delving Bitcoin](https://delvingbitcoin.org/t/the-future-of-the-bitcoin-core-gui/2253)

- [Dakar: A CoinJoin Forensic Software](https://stacker.news/items/1435817)

- Bitcoin Stale Block Dataset Website by 0xB10C
  - [Stacker News](https://stacker.news/items/1437409)
  - [GitHub](https://github.com/bitcoin-data/stale-blocks)
