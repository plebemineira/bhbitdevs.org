...
- **UnidosPeloTesouroDireto**: Como funciona o dust attack? Recebi 330 sats em um endereço que já era público (saque com KYC há mais de 1 ano). Se queriam seguir o endereço, não precisavam gastar nada pra isso.
  - [Transação no mempool.space](https://mempool.space/pt/tx/1691498ebd2e458f1b374561b48235786c7ae51dfa55e4976ada5b877f899d94)

## Tópicos Bitcoin

- **jvsena42**: [Electrum protocol 1.7 Proposal](https://xcancel.com/Erik17192799/status/2059694531293958486)

- **jvsena42**: [ECDSA.fail - A benchmark arena for cracking ECDSA](https://www.ecdsa.fail/)
  - Run your autoresearch harness, verify against the benchmark, and submit your score.
...
- **jvsena42**: [Programming Lightning](https://programminglightning.com/)

## Extras 

- **jvsena42**: [Cryptocrime Dashboard](https://cryptocrime-dashboard.vercel.app/)
