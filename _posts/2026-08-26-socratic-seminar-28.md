...
- **UnidosPeloTesouroDireto**: Quero imprimir um endereço com chave privada somente para armazenar BTC. As carteiras atuais não permitem gerar endereços sem palavras. O que é melhor?
  1. Gastar 2 horas jogando dados e depois queimar as palavras
  2. Gerar palavras na carteira com entropia duvidosa e colocar passphrase gigante?
...
- **jvsena42**: [Man vs. Machine. Or, why Man is not a Particularly Good Source of Entropy](https://www.loper-os.org/bad-at-entropy/manmach.html)

- **jvsena42**: [The Bitcoin Post Office](https://bitcoin-mempool.netlify.app/)

- **jvsena42**: [VULNERABILITY SPOILER ALERT - "Exposing patches before CVEs since 2025"](https://vulnerabilityspoileralert.com)